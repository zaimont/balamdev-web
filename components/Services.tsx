...
export default function Services() {
  return (
    <section
      id="servicios"
      className="border-t border-zinc-900 bg-zinc-950 px-6 py-32"
    >
        ...
        <div className="mt-16 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          ...
          <article className="group relative overflow-hidden rounded-2xl border border-zinc-800 bg-black p-8 transition duration-300 hover:-translate-y-1 hover:border-brand-500/40">
            ...
            <p className="mt-4 leading-7 text-zinc-400">
              ¿Necesitas un sistema que se adapte a tu negocio?
            </p>

            <Link
              href="/servicios"
              className="mt-8 inline-flex text-sm font-semibold text-white transition duration-300 group-hover:translate-x-1 group-hover:text-brand-400"
            >
              Conocer servicio →
            </Link>
          </article>
          ...
          <article className="group relative overflow-hidden rounded-2xl border border-zinc-800 bg-black p-8 transition duration-300 hover:-translate-y-1 hover:border-brand-500/40">
            ...
            <p className="mt-4 leading-7 text-zinc-400">
              ¿Tu operación está dispersa entre Excel, mensajes y procesos
              manuales?
            </p>
          ...
          <article className="group relative overflow-hidden rounded-2xl border border-zinc-800 bg-black p-8 transition duration-300 hover:-translate-y-1 hover:border-brand-500/40">
            ...
            <p className="mt-4 leading-7 text-zinc-400">
              ¿Hay tareas repetitivas que están consumiendo tiempo?
            </p>
